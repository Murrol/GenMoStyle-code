...
class Config:
    ...
    # Save & Visualization
    name = 'unpaired_my1603d'     # name of the experiment, for training from scratch please use a different name
    ...
    def initialize(self, args=None, save=True):
        ...
        if hasattr(args, 'motion_length') and args.motion_length is not None:
            self.motion_length = args.motion_length

        self.gpu_id = args.gpu_id
        self.cuda_id = self.gpu_id
